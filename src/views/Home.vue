    ...
    <van-list v-model:loading="loading" :finished="finished" finished-text="没有更多了">
        ...
        <div class="sys-desc">
            ...
            <p class="sys-desc-content">
                我们是北京交通大学软件学院研究生暑期社会实践团，为内蒙古科左后旗的中小学生们量身打造了一个全面、丰富的学习资源平台“步流云海”。在这里，你可以找到丰富多样的学习资源，包括从小学一年级到初中三年级课内各科的知识点、教材讲解，同时也提供了各种拓展学习资源，如优秀纪录片、学习经验分享等。希望你们可以在这里尽情探索，享受成长的喜悦；展翅高飞，追求知识的无尽辽阔。
            </p>
            <p class="sys-desc-content">
